...
public class AlarmSettingAgain extends Activity {
    ...
    public final static String MESSAGE_EXTRA = "message_extra";
    private MediaPlayer mp = new MediaPlayer();//音频
    private Vibrator vibrator;//震动
    private PowerManager.WakeLock mWakelock;//唤醒屏幕
    private String title = "闹钟提醒时间到了!";
    private String message = "闹钟时间到了!!!";
...
//		message = getIntent().getStringExtra(MESSAGE_EXTRA);
